...
from ..nets import GlobalLocalNet, HeadGlobalEncoderLocalNet  # NOQA
...
class FLHalfClient(PFLClient):
    def __init__(self,
        ...
        self.anchors = None
        self.personalized_model = HeadGlobalEncoderLocalNet(self.personalized_model)
            ...
            if self.hyper_params.relative:
                test_loader = FastDataLoader(
                    relative_projection(self.personalized_model.forward_local,
                                        ...
                                        self.anchors),
                    self.test_set.tensors[1],
                    num_labels=self.test_set.num_labels,
