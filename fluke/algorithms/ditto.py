...
__all__ = ["PerturbedGradientDescent", "DittoClient", "Ditto"]
...
class DittoClient(PFLClient):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.hyper_params.update(tau=tau, lam=lam)
        self._save_to_cache()

    def _proximal_loss(
        self, local_model: torch.nn.Module, global_model: torch.nn.Module
    ) -> torch.Tensor:
        proximal_term = 0.0
