...
__all__ = ["CalibratedLoss", "FedLCClient", "FedLC"]
...
class CalibratedLoss(torch.nn.Module):
    ...
    def __init__(
        self, tau: float, label_distrib: torch.Tensor, reduction: Literal["mean", "sum"] = "mean"
    ):
        super().__init__()
        self.tau = tau
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            ...
            loss_fn=CalibratedLoss(tau, label_counter),
